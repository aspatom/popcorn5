  ...
  //      LCD_DisplayStringLine(Line4, (uint8_t*)"     Looking for    ");
     //   LCD_DisplayStringLine(Line5, (uint8_t*)"     DHCP server    ");
        //LCD_DisplayStringLine(Line6, (uint8_t*)"     please wait... ");
				LCD_LINE_Control(Line4,"     Looking for    ");
				LCD_LINE_Control(Line5, "     DHCP server    ");
        LCD_LINE_Control(Line6, "     please wait... ");
...
//            LCD_DisplayStringLine(Line8, (uint8_t*)"  Static IP address   ");
 //           LCD_DisplayStringLine(Line9, iptxt);
						LCD_LINE_Control(Line8, "  Static IP address   ");
						LCD_LINE_Control(Line9,iptxt);
#endif
            vTaskDelete(NULL);
          }
        }
